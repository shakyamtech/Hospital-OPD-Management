js = '''
        ...
        pharmacyTbody.innerHTML = pharmPatients.map(p => {
            ...
            return \
                <tr>
                    ...
                    <td>
                        <button class="btn-primary" onclick="window._managePharmacyBill('\')">
    ...
    function addPharmacyRow(name = '', qty = 1, rate = 0) {
        ...
        tr.innerHTML = \
            <td><input type="text" class="medicine-row-input pharm-name" value="\" placeholder="Medicine Name"></td>
            <td><input type="number" class="medicine-row-input pharm-qty" value="\" min="1" oninput="window._updatePharmRowTotal(this)"></td>
            <td><input type="number" class="medicine-row-input pharm-rate" value="\" min="0" step="0.01" oninput="window._updatePharmRowTotal(this)"></td>
            <td class="row-total-display">Rs \</td>
    ...
    window._updatePharmRowTotal = function(inputElem) {
        ...
        tr.querySelector('.row-total-display').textContent = \Rs \\;
        updatePharmacyGrandTotal();
    };
    ...
    function updatePharmacyGrandTotal() {
        ...
        document.getElementById('pharm-grand-total').textContent = \Rs \\;
    }
...
'''
with open('d:\\\\Developing\\\\OPD\\\\app.js', 'a', encoding='utf-8') as f:
    f.write(js)
