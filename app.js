...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.printPharmacyInvoice = function(patient, pharmacyBill) {
        ...
        let iframe = document.getElementById('print-pharmacy-iframe');
        if (!iframe) {
            iframe = document.createElement('iframe');
            iframe.id = 'print-pharmacy-iframe';
            iframe.style.position = 'fixed';
            iframe.style.right = '0';
            iframe.style.bottom = '0';
            iframe.style.width = '0';
    ...
    function printPharmacyReceipt(customerName, contact, items, grandTotal) {
        ...
        const fileName = `${safeName} - Receipt - ${dateShort}`;
...
<body>
    <div class="receipt-card">
        ...
        // Use Blob URL so Chrome picks up the title for the filename in save dialog
